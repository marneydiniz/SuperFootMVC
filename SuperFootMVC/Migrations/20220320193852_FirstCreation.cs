    ...
    public partial class FirstCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChampionshipSeason", x => new { x.ChampionshipsId, x.SeasonsId });
                    table.ForeignKey(
                        name: "FK_ChampionshipSeason_Championships_ChampionshipsId",
                        column: x => x.ChampionshipsId,
                        principalTable: "Championships",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ChampionshipSeason_Seasons_SeasonsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefenseScore = table.Column<int>(type: "int", nullable: false),
                    AttackScore = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitantTeamId = table.Column<int>(type: "int", nullable: false),
                    ScoreHomeTeam = table.Column<int>(type: "int", nullable: false),
                    ScoreVisitantTeam = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Teams_VisitantTeamId",
                        column: x => x.VisitantTeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Championships_ChampionTeamId",
                table: "Championships",
                column: "ChampionTeamId");

            migrationBuilder.CreateIndex(
                name: "IX_ChampionshipSeason_SeasonsId",
                table: "ChampionshipSeason",
                column: "SeasonsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_VisitantTeamId",
                table: "Matches",
                column: "VisitantTeamId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Championships_Teams_ChampionTeamId",
                table: "Championships",
                column: "ChampionTeamId",
                principalTable: "Teams",
                principalColumn: "Id",
